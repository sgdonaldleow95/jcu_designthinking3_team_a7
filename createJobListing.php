...
<section>
    <div id="content">
        <center>
            ...
            <br><br>
            <form name="comapnyProfile" method="post" action="doUpdateJobListing.php" ENCTYPE="multipart/form-data">
                <table>
                    <tr>
                        <td>Job ID:</td><td><input type='text' name='jobid' placeholder="Job ID Number" required></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Contract Length:</td><td><input type="text" name="duration" placeholder="Employment contract duration" required></td>
                    </tr>
                    <tr>
                        <td>Job Scope Description:</td><td><textarea rows="4" cols="40"></textarea></td>
                    </tr>
                    <tr>
                        <td>Job Requirement:</td><td><textarea rows="4" cols="40"></textarea></td>
                    </tr>
                </table>
