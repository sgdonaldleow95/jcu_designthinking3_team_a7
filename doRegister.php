    ...
    <section>
        <div id="content2">
            ...
            if (mysqli_num_rows($results) > 0){
                ...
                $insertQuery = "INSERT INTO registered_users (username, password, email, usertype,securityquestion, answer) VALUES ('$username', '$password2', '$email', '$usertype','$squestions', '$sanswers')";
